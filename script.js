...
document.querySelectorAll('.project-card, .achievement-card, .skill-category, .certification-card, .experience-card').forEach(el => {
    observer.observe(el);
});
...
style.textContent = `
    .project-card, .achievement-card, .skill-category, .certification-card, .experience-card {
        opacity: 0;
